...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
	...
	public int intVideoWidth=0,intVideoHeight=0;
	...
	public void setVideoLayout(int layout, float aspectRatio) {
		...
		if(this.isZoom && this.intVideoHeight>0 && this.intVideoWidth>0){
			lp.width=this.intVideoWidth;
			lp.height=this.intVideoHeight;
		}
		setLayoutParams(lp);
