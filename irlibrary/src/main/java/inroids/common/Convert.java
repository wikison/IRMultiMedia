...
public abstract class Convert {
	...
	public static int stringToColor(String sColor) {
		try{
			...
			MyLog.e(strTag,"Convert.stringToColor:"+ e.toString());
		}
		return 0;
	}
	...
	public static int stringRGBToColor(String sColor) {
		try{
			...
			MyLog.e(strTag,"Convert.stringRGBToColor:"+ e.toString());
		}
		return 0;
	}
	...
	public static String colorToString(int sColor) {
		try{
			...
			MyLog.e(strTag,"Convert.colorToString:"+ e.toString());
		}
		return null;
	}
	...
	public static String colorToRGBString(int sColor) {
		try{
			...
			MyLog.e(strTag,"Convert.colorToRGBString:"+ e.toString());
		}
		return null;
	}
	...
	public static String dateToString(Date dDate,String sFormat){
		try {
			...
			MyLog.e(strTag,"Convert.dateToString:"+ e.toString());
		}
		return null;
	}
	...
	public static Date stringToDate(String dDate,String sFormat){
		try {
			...
			MyLog.e(strTag,"Convert.stringToDate:"+ e.toString());
		}
		return null;
	}
	...
	public static String byteToHexString(byte[] buf)  { 
		try{
			...
			MyLog.e(strTag,"Convert.byteToHexString:"+ e.toString());
		}
		return null;
	}
	/** 
	...
	public static byte[] stringToByte(String hexString) {  
		try{
			...
			MyLog.e(strTag,"Convert.stringToByte:"+ e.toString());
		}
		return null;
	}
}
