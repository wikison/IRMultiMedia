...
public class MyLog {  
    ...
    private static void writeLogtoFile(String mylogtype, String tag, String text) {// 新建或打开日志文件  
    	String strPath;
    	if(FileManage.isExistsFolder("/mnt/flash")){
    		strPath="/mnt/flash/";
    	}else{
    		strPath="/mnt/sdcard/";
    	}
        ...
        File file = new File(strPath, needWriteFiel+ MYLOGFILEName);  
        try {  
        	delFile(strPath);//删除旧日
     ...
     * 删除指定的日志文件 
     * */  
    public static void delFile(String sPath) {// 删除日志文件  
        String needDelFiel = logfile.format(getDateBefore());  
        File file = new File(sPath, needDelFiel + MYLOGFILEName);  
        if (file.exists()) {  
            file.delete();  
        }  
    }  
